...
class ReadRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'counter_number'),
    ...
    ..aOM<SampleSchema>(4, _omitFieldNames ? '' : 'dummyTwo',
        subBuilder: SampleSchema.create)
...
class ReadResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<SampleSchema>(3, _omitFieldNames ? '' : 'dummyTwo',
        subBuilder: SampleSchema.create)
...
class SampleSchema extends $pb.GeneratedMessage {
  ...
  factory SampleSchema.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SampleSchema.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SampleSchema',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'counter_number'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SampleSchema copyWith(void Function(SampleSchema) updates) =>
      super.copyWith((message) => updates(message as SampleSchema))
          as SampleSchema;
  ...
  static $pb.PbList<SampleSchema> createRepeated() =>
      $pb.PbList<SampleSchema>();
  @$core.pragma('dart2js:noInline')
  static SampleSchema getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SampleSchema>(create);
  static SampleSchema? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get sampleFieldOne => $_getBF(0);
  @$pb.TagNumber(1)
  set sampleFieldOne($core.bool v) {
    $_setBool(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set sampleFieldTwo($core.bool v) {
    $_setBool(1, v);
  }

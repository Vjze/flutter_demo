...
class ReadRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'query_resource'), createEmptyInstance: create)
...
class ReadResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'query_resource'), createEmptyInstance: create)
    ..pc<DataInfos>(1, _omitFieldNames ? '' : 'outputLists', $pb.PbFieldType.PM, protoName: 'output_Lists', subBuilder: DataInfos.create)
    ..hasRequiredFields = false
  ;
...
class DataInfos extends $pb.GeneratedMessage {
  ...
  DataInfos._() : super();
  factory DataInfos.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DataInfos.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataInfos', package: const $pb.PackageName(_omitMessageNames ? '' : 'query_resource'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataInfos copyWith(void Function(DataInfos) updates) => super.copyWith((message) => updates(message as DataInfos)) as DataInfos;
  ...
  @$core.pragma('dart2js:noInline')
  static DataInfos getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DataInfos>(create);
  static DataInfos? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get pno => $_getSZ(0);
  @$pb.TagNumber(1)
  set pno($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set pn($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set workid($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set datatime($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
